  ...
  return (
    <div className="homepage-body">
      ...
      <main className="hero-section">
        ...
        <a href="https://drive.google.com/file/d/1APSnKeG_bUYtVmAfQr0WhkKxK9-ws2O9/view?usp=sharing" target="_blank" className="btn-learn-more" rel="noopener noreferrer">Learn More</a>
      ...
      <section className="hp-video-section">
        <div className="hp-video-wrapper">
          <iframe src="https://www.youtube-nocookie.com/embed/jQkANpci7Aw?rel=0" frameBorder="0" allowFullScreen title="AMX UAV Promotional Video"></iframe>
        </div>
      </section>
        ...
        <div className="hp-basic-articles-list">
          <Link href="/products/dronepedia/how-it-works" className="hp-basic-articles-card-list">
            ...
            <div className="hp-basic-card-list-img">
              ...
              <img src="/img/AMX-GCS.jpg" alt="Ground Control Station" />
            </div>
          </Link>
          <Link href="/products/mapping/vertic-xl" className="hp-basic-articles-card-list">
            ...
            <div className="hp-basic-card-list-img">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/img/AMX-GCS.jpg" alt="Vertic XL Mission Planning" />
            </div>
          </Link>
        </div>
      </section>
          ...
          {[1, 2, 3].map((i) => (
            <div className="hp-card-list" key={i}>
              ...
              <div className="hp-card-list-img">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src="/img/AMX-GCS.jpg" alt={`Article ${i}`} />
              </div>
            </div>
          ))}
        </div>
